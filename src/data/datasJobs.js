...
const datasJobs = () => {
    const datas = [
        {name: 'Glassdoor', site: 'https://www.glassdoor.com/', path: 'https://www.glassdoor.com/Community/index.htm'},
        ...
        {name: 'Talent', site: 'https://br.talent.com', path: 'https://br.talent.com'},
        {name: 'Job Center', site: 'https://www.jobcenter.com.br/', path: 'https://www.jobcenter.com.br/'},
        {name: 'Luandre', site: 'https://luandre.com.br/', path: 'https://luandre.com.br/'},
        {name: 'Sprinter', site: 'https://sprinter.tweezer.jobs/', path: 'https://sprinter.tweezer.jobs/candidato/vaga/buscar_vaga/'},
        {name: 'Rheferência', site: 'http://www.rheferencia.com.br/', path: 'http://www.rheferencia.com.br/'},
        {name: 'Agência GMS', site: 'https://gmsservicos.com.br/', path: 'https://gmsservicos.com.br/'},
        {name: 'O Amarelinho', site: 'https://noticias.oamarelinho.com.br/', path: 'https://noticias.oamarelinho.com.br/category/guia-de-empregos/'},
        {name: 'Vagas', site: 'https://www.vagas.com.br/', path: 'https://www.vagas.com.br/'},
